...
//If already auth go to zabgraphs.php
if($_COOKIE["zabgraphs_session"]) {
	header("location:zabgraphs.php");
}
...
//If login successful 	
if (strlen($login) === 32) {
	setcookie('zabgraphs_session', $login, time() + (86400 * 7), "/");
	header("location:zabgraphs.php");
}
	...
	<div class="login-box">
		...
		<div class="login-box-body">
			<div class="login-logo">
				<img src="img/netflow2.png" style="height: 40px;" alt=""><b>ZabGraphs</b>
			</div>
